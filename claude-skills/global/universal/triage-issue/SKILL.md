---
name: triage-issue
description: Investigate a reported bug by exploring the codebase, find root cause, and create a GitHub issue with a TDD-based fix plan. Use when user says "triage", reports a bug to track, or wants to file an issue for a problem. Not for active debugging during development (use systematic-debugging for that).
---
